...
static char ssid[] = "beaulieu";  // your network SSID (name)
static char pass[] = "9996458191892265fitbobojimbo"; // your network password
int         status = WL_IDLE_STATUS;       // the Wifi radio's status

const static char pubkey[]  = "pub-c-4f10f9cd-acff-4f28-99aa-5cf1889d9100";        // your publish key
const static char subkey[]  = "sub-c-bfa9cc1c-91cf-11eb-a414-3ac7414c19a1";        // your subscribe key
const static char channel[] = "julia"; // channel to use
...
void messageRead() {
    char msg[]  = "{ \"Device\": \"Julia\", \"Message\": \"Received\"}";
